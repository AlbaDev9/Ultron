...
export declare class VoiceClient {
     ...
     */
    sortUsers(message: Message): Promise<userObject[]>;
    /**
     * @description Gives you all the data you need about a user
     * @param {Message} message discord.js's Message class
     * @param {User} user discord.js's User class
     */
    getUserData(message: Message, user: User): Promise<userData>;
    /**
     ...
     * @param {Message} message discord.js's Message class
     */
    reset(message: Message): Promise<void>;
    /**
     ...
     */
    setTime(message: Message, user: User, time: number): void;
    /**
